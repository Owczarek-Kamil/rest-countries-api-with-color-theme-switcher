...
export default function ThemeToggle({ theme }: ThemeProp) {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="-mr-3 flex cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-ink-primary transition-colors hover:bg-ink-primary/5 focus-visible:outline-offset-4">
      {!mounted ? (
