...
- [x] **Add hover styles for interactive elements** - _"Curiously, your interactive components have excellent native focus states (when using keyboard navigation), but they lack visual shifts on mouse hover. Desktop mouse users need that same immediate feedback to know an element is clickable"_
